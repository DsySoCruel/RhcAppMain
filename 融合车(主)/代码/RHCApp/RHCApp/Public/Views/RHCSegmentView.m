...
- (void)setTitles:(NSArray *)titles {
    ...
    for (NSUInteger i = 0; i < count; i++) {
        ...
        if (self.needSeparatorLine && i != count - 1) {
            ...
            sepapatorLine.backgroundColor = RGB(0xCBDCFF);
            sepapatorLine.frame = CGRectMake(titleButton.rcm_right, 0, 0.5, 20);
