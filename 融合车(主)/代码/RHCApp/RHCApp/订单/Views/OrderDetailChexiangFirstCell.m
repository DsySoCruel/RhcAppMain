//
//  OrderDetailChexiangFirstCell.m
//  RHCApp
//
...
@interface OrderDetailChexiangFirstCell ()
...
@implementation OrderDetailChexiangFirstCell
...
- (void)setModel:(OrderChexiangDetailModel *)model{
    ...
    self.d.text = [NSString stringWithFormat:@"创建时间: %@",[model.create_time timeFromNow]];
}
