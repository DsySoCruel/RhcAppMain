//
//  CarSuperStoreController.m
//  RHCApp
//
//  Created by daishaoyang on 2018/8/29.
//
...
@interface CarSuperStoreController ()<UINavigationControllerDelegate,DOPDropDownMenuDelegate, DOPDropDownMenuDataSource,UITableViewDelegate,UITableViewDataSource>
...
@implementation CarSuperStoreController
...
- (void)setupUI{
    //1.设置导航条
    self.naviView = [[NavigationSearchBarView alloc] initWithType:NavigationSearchBarTypeCarStore];
...
//     [tempArray addObject:@"1234"];
    ...
    self.array5 = @[@"类型",@"微小型车",@"紧凑型车",@"中型车",@"中大型车",@"SUV",@"MPV",@"跑车"];;
